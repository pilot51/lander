...
public class Consts {
	...
	public enum ResponseCode {
		...
		public static ResponseCode valueOf(int index) {
			...
			if (index < 0 || index >= values.length) { return RESULT_ERROR; }
			return values[index];
		}
	}
	...
	public enum PurchaseState {
		...
		public static PurchaseState valueOf(int index) {
			...
			if (index < 0 || index >= values.length) { return CANCELED; }
			return values[index];
		}
	}
	...
	public static final String ACTION_CONFIRM_NOTIFICATION =
		"com.pilot51.lander.CONFIRM_NOTIFICATION";
	public static final String ACTION_GET_PURCHASE_INFORMATION =
		"com.pilot51.lander.GET_PURCHASE_INFORMATION";
	public static final String ACTION_RESTORE_TRANSACTIONS =
		"com.pilot51.lander.RESTORE_TRANSACTIONS";

...
public class Security {
	private static final String TAG = Main.TAG + "-Security";
	 ...
	 * be "static" so that the {@link BillingReceiver} can check if a nonce exists.
	 */
	 ...
	 * purchases. The data is in JSON format and contains a nonce (number used once) that we
	 * generated and that was signed (as part of the whole data string) with a private key. The data
	 * also contains the {@link PurchaseState} and product ID of the purchase. In the general case,
	 * there can be an array of purchase transactions because there may be delays in processing the
	 * purchase on the backend and then several purchases can be batched together.
	 * 
	 * @param signedData
		...
		if (!TextUtils.isEmpty(signature)) {
			...
			verified =
				Security
					.verify(
						Security
							.generatePublicKey(""),
